...
O'zgaruvchi (variable) — qiymatga bog'langan nom. Python'da o'zgaruvchi qiymatni "ichida saqlaydigan quti" emas, balki xotiradagi obyektga ishora qiladigan nom sifatida ishlaydi.

O'zgaruvchilar turli ma'lumot turlariga bog'lanishi mumkin. Python'da ularni oldindan ma'lum bir tur bilan e'lon qilish shart emas; dastur ishlayotganda nom boshqa turdagi qiymatga qayta bog'lanishi mumkin.
...
3. O'zgaruvchi nomlari katta-kichik harflarni farqlaydi. Masalan, `firstName` va `firstname` — turli o'zgaruvchilar.
...
Python bitta qatorda bir nechta o'zgaruvchiga qiymat berishi mumkin — bu qiymatlarni yoyish (`unpacking`) va almashtirish uchun qulay:
...
Yuqoridagi qoidalar nima *ruxsat etilganini* aytadi; konvensiyalar esa nima *o'qilishi qulay* ekanini ko'rsatadi. Python kodi odatda quyidagi uslublarga amal qiladi:
