...
<img src="/img/tutorial/15-python-list-comprehension.webp" alt="Python List Comprehension" class="w-full rounded-lg shadow-md mb-6" loading="lazy">
...
# Avoid compact expressions like this when logic gets complex:
