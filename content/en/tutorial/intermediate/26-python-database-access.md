...
<div class="warning">To run this snippet, you must have <code>pymysql</code> installed and a running MySQL database configured with the credentials below.</div>
