...
<img src="/img/tutorial/27-python-networking.webp" alt="Python Networking Tutorial" class="w-full rounded-lg shadow-md mb-6" loading="lazy">
...
<div class="warning">This server snippet will block your terminal waiting for a connection. Run the client code in another terminal to unblock it or press Ctrl+C to cancel.</div>
