...
order: 1
permalink: /tutorial/en/what-is-python/
---

<img src="/img/tutorial/1-pendahuluan-python.webp" alt="Introduction to Python - What is Python" class="w-full rounded-lg shadow-md mb-6" loading="lazy">
