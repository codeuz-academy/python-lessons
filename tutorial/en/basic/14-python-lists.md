...
title: Python List
order: 14
permalink: /tutorial/en/python-lists/
---

<img src="/img/tutorial/13-tipe-data-list-python.webp" alt="Python List Data Type" class="w-full rounded-lg shadow-md mb-6" loading="lazy">
