...
layout: tutorial.njk
lang: uz
title: Python satrlar (string)
order: 12
permalink: /tutorial/uz/python-strings/
---

<img src="/img/tutorial/12-tipe-data-string-python.webp" alt="Python string ma'lumot turi" class="w-full rounded-lg shadow-md mb-6" loading="lazy">
