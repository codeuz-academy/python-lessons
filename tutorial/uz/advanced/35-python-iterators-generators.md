...
order: 35
permalink: /tutorial/uz/python-iterators-generators/
---

<img src="/img/tutorial/30-belajar-iterators-generators-python.webp" alt="Python iterators va generators" class="w-full rounded-lg shadow-md mb-6" loading="lazy">

Python'da iterator va generator'lar xotirani tejash (memory efficiency) uchun juda muhim. Ular katta hajmdagi data (hatto cheksiz)ni ham hammasini bir yo'la RAM'ga yuklamasdan, bo'laklab qayta ishlashga imkon beradi.
...
Texnik jihatdan, Python'da iterator - iterator protocol'ni implement qiladigan obyekt bo'lib, `__iter__()` va `__next__()` metodlariga ega bo'ladi.
