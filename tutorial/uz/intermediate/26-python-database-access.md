...
layout: tutorial.njk
lang: uz
title: Python'da database bilan ishlash
order: 26
permalink: /tutorial/uz/python-database-access/
---
...
[PyMySQL](https://pymysql.readthedocs.io/en/latest/) - DB-API 2.0 ni implement qiladigan pure-Python MySQL client.
SQLite bilan ishlasangiz, Python standard library'da `sqlite3` allaqachon bor.
...
Database credential'larni bir marta sozlab, har bir bo'limda `get_connection()` ni qayta ishlating.
